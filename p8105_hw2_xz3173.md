...
datasets. The `mci_df` data has 1884 observations and 9 variables and
tells us about the partcipants who attend both datasets with the
information on the basic demographic information measured at the study
baseline, the the development of MCI at the baseline age and the age at
onset, and the APOE4 carrier, as well as the biomarker amyloid value in
a set of follow up years.
